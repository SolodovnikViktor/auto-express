  ...
  <header class="header">
    <div class="container">
      <div class="header__top">
        <?php the_custom_logo(); ?>
        <a class="phone" href="<?php the_field('phone_href'); ?>"><?php the_field('phone'); ?></a>
      </div>
      <div class="header__content">
        ...
        <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('top_imag'); ?>" alt="ford mustang">
      </div>
    </div>
  </header>